...
import sys
# from input import DataInput, DataInputDev
# from model import Model
from input_cntxt import DataInput, DataInputDev
from model_cntxt import Model
...
with open('../data/dataset_with_cntxt_neg_100.pkl', 'rb') as f:
...
def _eval(sess, model):
  auc_sum = 0.0
  score_arr = []
  for _, uij in DataInputDev(test_set, test_batch_size):
  ...
  if best_auc < test_gauc:
    best_auc = test_gauc
    model.save(sess, 'save_path/cntxt_merged_neg_100_0113/ckpt')
...
def _test(sess, model):
  ...
  for _, uij in DataInputDev(test_set, predict_batch_size):
